   ...
   public  class MessageBuilder
    {
        ...
        {
            msg = new Message(new Jid(to + "@" + GlobalViables.DomainName + "/" + enum_XmppResource.YDBan_DianDian)
              , new Jid(from + "@" + GlobalViables.DomainName + "/" + enum_XmppResource.YDBan_DianDian), body);
