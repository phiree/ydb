...
using Ydb.Common;
namespace Ydb.ApiClient.Intrastructure.YdbNhibernate.UnitOfWork
{
    ...
    {
        log4net.ILog log = log4net.LogManager.GetLogger("Ydb.ApiClient.Intrastructure.YdbNhibernate.UnitOfWork.NhUnitOfWorkInterceptor");
