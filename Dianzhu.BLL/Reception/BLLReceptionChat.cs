...
namespace Dianzhu.BLL
{
    ...
    public class BLLReceptionChat
    {
        ...
        public IList<ReceptionChat> GetReceptionChatListByTargetIdAndSize(Guid fromId, Guid toId, Guid orderId, DateTime begin, DateTime end,
             int pageSize, double savedTimestamp, string low, enum_ChatTarget target)
        {
            return DALReceptionChat.GetReceptionChatListByTargetIdAndSize(fromId, toId, orderId, begin, end, pageSize, savedTimestamp, low, target);
