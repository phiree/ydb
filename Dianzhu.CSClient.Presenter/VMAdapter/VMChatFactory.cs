...
namespace Dianzhu.CSClient.Presenter.VMAdapter
{
    public class VMChatFactory
    {
        ...
        public VMChatFactory(string chatId, string fromId, string fromName, string toId, DateTime savedTime,double savedTimestamp, string csAvatar, string customerAvatar, string chatBackground, bool isFromCs)
        {
            this.chatId = chatId;
            this.fromId = fromId;
        ...
        public VMChat CreateVMChatText(string messageBody)
        {
            return new VMChatText(messageBody, 
                chatId, fromId, fromName, toId, savedTime, savedTimestamp, csAvatar, customerAvatar, chatBackground, isFromCs);
        }
