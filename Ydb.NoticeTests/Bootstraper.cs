...
public class Bootstrap
{
    ...
    public static FluentConfiguration dbConfig
    {
        get
        {
            FluentConfiguration dbConfigBusiness = Fluently.Configure()
             ...
             Standard
             .ConnectionString("Data Source=test_ydb_notice.db3; Version=3;BinaryGuid=False")
             )
    ...
    public static void Boot()
    {
       ...
       .ExposeConfiguration((config) => { new SchemaExport(config).Create(true, true); });
        ...
        container.Install(
            ...
            new Ydb.Notice.InstallerNotice(dbConfig)
            );

        Ydb.Common.LoggingConfiguration.Config("Ydb.Notice.Tests");
