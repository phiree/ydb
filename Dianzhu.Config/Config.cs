...
namespace Dianzhu.Config
{
    ...
    {
        /************** 部署前，只需要手动修改此处**********************************/
        static string DatabaseServer = "business.ydban.cn";//数据库地址
        static string IMServer = "business.ydban.cn";//即时通讯服务器地址
        static string ApplicationServer = "business.ydban.cn";//应用服务器地址
       /***************** END*******************************************************/
