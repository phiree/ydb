...
public    class ServiceOrderTest
    {
        ...
        public void AddDetailFromIntelServiceTest()
        {
            ...
            order.AddDetailFromIntelService(service, 1,string.Empty,string.Empty, string.Empty, DateTime.Now, string.Empty);
            Assert.AreEqual(1, order.Details.Count);
            order.AddDetailFromIntelService(service, 2,string.Empty,string.Empty, string.Empty, DateTime.Now, string.Empty);
            Assert.AreEqual(1, order.Details.Count);
