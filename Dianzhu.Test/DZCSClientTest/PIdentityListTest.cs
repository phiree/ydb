...
namespace Dianzhu.Test.DZCSClientTest
{
    ...
    public class PIdentityListTest
    {
        ...
        public void setup()
        {
            ...
            pIdentityList = new PIdentityList(viewIdentityList, viewChatList, iIM, dalReceptionChat, viewChatSend, bllServiceOrder, viewOrderHistory, dalReceptionStatus, viewSearchResult, dalReceptionStatusArchieve,lcm,lhom);
