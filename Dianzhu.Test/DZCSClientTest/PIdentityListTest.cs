    ...
    public class PIdentityListTest
    {
       ...
       IChatService chatServive;
        ...
        public void setup()
        {
            ...
            IViewMainForm viewMainForm = MockRepository.GenerateStub<IViewMainForm>();
            ...
            pIdentityList = new PIdentityList(viewIdentityList, viewChatList, iIM,
                ...
                lcm,lhom,luidm, vmChatAdapter, vmIdentityAdapter, receptionService, memberService, viewMainForm);
        ...
        public void IdentityClick_Test()
        {
            ...
            PChatList pChatList = new PChatList(viewChatList, viewChatSend, viewIdentityList, iIM,lcm, vmChatAdapter, chatServive,string.Empty);
