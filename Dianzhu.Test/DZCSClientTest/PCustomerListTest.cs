    ...
    public class PCustomerListTest
    {
        ...
        public void ReceiveMessageTest()
        {
            ...
            IList<ReceptionChat> chats = Builder<ReceptionChat>.CreateListOfSize(6)
                ...
                .Build();
            PIdentityList pCustomerList = new PIdentityList(viewCustomerList, viewChatList,iIM, dalReceptionChat, viewChatSend, bllServiceOrder, viewOrderHistory, dalReceptionStaus, viewSearchResult, dalReceptionStatusArchieve,lcm,lhom, luid);
