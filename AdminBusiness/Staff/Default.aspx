            ...
            <table class="emp-table">
                ...
                <ItemTemplate>
                 <tr>
                  ...
                  <td class="emp-td-style epm-btn epm-th-1"><span class='<%# ((bool)Eval("IsAssigned"))?"assigned":"notassigned" %> none'><%# (bool)Eval("IsAssigned")?"已指派":"未指派" %></span> <input type="button" staffid='<%#Eval("id") %>' class="btnAssign btn btn-info" value='<%# (bool)Eval("IsAssigned")?"取消指派":"指派" %>'/> 
