                ...
                <div class="service-info info-bottom">
                    ...
                    <table class="custom-table">
                        ...
                        <tr>
                            ...
                            <td class="table-col-1"><%=(CurrentService.AllowedPayType & Dianzhu.Model.Enums.enum_PayType.Offline) == Dianzhu.Model.Enums.enum_PayType.Offline?"线下":string.Empty%><%=(CurrentService.AllowedPayType & Dianzhu.Model.Enums.enum_PayType.Online) == Dianzhu.Model.Enums.enum_PayType.Online ? "线上" : string.Empty%></td>
