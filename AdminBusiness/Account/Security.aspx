                        ...
                        <div class="col-md-9">
                            <div class="model m-b20">
                                ...
                                <div class="model-m">
                                    ...
                                    <div class="secret-pra">
                                        <div>
                                            <span class="secret-t">绑定邮箱:</span><span class="secret-m" id="currentUserEmail"><span class="m-r20"><%=CurrentUser.Email%></span><span id="currentUserEmailVali" class="secret-d-a d-inb dis-n"><% if (CurrentUser.IsRegisterValidated)
                                                                                                                                                                                 {%>已验证<%}
                  else
                  {%><span class="text-r m-r10">未验证</span><asp:Button runat="server" CssClass="reVali  secret-btn" Text='发送验证链接' ID='btnResendEmailVerify' OnClick="btnResendEmailVerify_Click" /><%}%></span></span>
                                            <a id="lb_changeEmail" class="m-l20 secret-btn" href="javascript:void(0);">修改</a>
                                        </div>
                        ...
                        <SuccessTemplate>
                            <div id="CPResult" class="m-auto" ng-hide="CPassSuccess">
                                ...
                                <div class="secret-change-sub">
                                    <input class="lightClose secret-btn-done" ng-click="CPassReset()" type="button" value="确认" />
                                </div>
                            </div>
                        </SuccessTemplate>
