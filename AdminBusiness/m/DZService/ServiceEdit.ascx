...
<div data-role="content" style="background: #cadbec; color: #617e9c; margin: 0; padding: 0;">
    <div class="m-p-size pd-size">
        ...
        <div class="info-content">
            <div class="pd-size2">
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_name">
                        <li class="my-li6">
                            <div class="ul-left">
                                服务名称
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_servicetype">
                        <li class="my-li6">
                            <div class="ul-left">
                                服务类别
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_description">
                        <li class="my-li">
                            <div class="ul-left">
                                <div>
                                    服务介绍</div>
    ...
    <div class="m-p-size pd-size">
        ...
        <div class="info-content">
            <div class="pd-size2">
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_servicescope">
                        <li class="my-li6">
                            <div class="ul-left">
                                服务范围
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_unitprice">
                        <li class="my-li6">
                            <div class="ul-left">
                                服务单价
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_preorder_delay">
                        <li class="my-li6">
                            <div class="ul-left">
                                提前预约时长
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_maxorder_day">
                        <li class="my-li6">
                            <div class="ul-left">
                                每日最大接单量
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_maxorder_hour">
                        <li class="my-li6">
                            <div class="ul-left">
                                每小时最大接单量
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_servicemode">
                        <li class="my-li6">
                            <div class="ul-left">
                                是否上门
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_is_for_business">
                        <li class="my-li6">
                            <div class="ul-left">
                                可以对公
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_compensation">
                        <li class="my-li6">
                            <div class="ul-left">
                                先行赔付
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_certificated">
                        <li class="my-li6">
                            <div class="ul-left">
                                平台认证
                            </div>
                ...
                <ul class="panel-ul">
                    <a class="hrefClass" id="open_paytype">
                        <li class="my-li6">
                            <div class="ul-left">
                                支付方式
                            </div>
