...
(function (){
    ...
    $.extend(AssignCollection.prototype, {
        ...
        sync : function(method, data, callback){
            ...
            var reqData = Adapter.reqPackage(setApiCode, data );
    ...
    $.extend(ItemCollection.prototype, {
        ...
        sync : function(data, callback){
            ...
            assignSync = assignCollection.sync("select", data);
    ...
    $.extend(AppModel.prototype, {
        _assignBuild : function(){
            ...
            $.each(itemCollection.models, function(index, model){
                ...
                assignObj.orderID = _this.attribute.orderID;
        ...
        _assignSync : function(callback){
            ...
            reqData.storeID = this.attribute.storeID;
    ...
    $.extend(AppView.prototype, {
        ...
        refresh :function(){
            ...
            itemCollection.sync(assReqData, function(models){
