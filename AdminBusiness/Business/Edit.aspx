...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="cont-wrap theme-color-58789a">
        ...
        <div class="bottomArea">
            <input class="btn btn-info btn-big" name="imageField" runat="server" onserverclick="btnSave_Click"
                   type="submit" id="imageField1" value="保存"/>
            <a class="btn btn-cancel btn-big m-l10" href="/business/detail.aspx?businessId=<%=Request[" businessid"]
            %>">取消</a>
        </div>
    </div>
    <!--</div>-->
