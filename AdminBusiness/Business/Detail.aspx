    ...
    <div class="cont-wrap">
        <div class="mh-in">
            <div class="cont-container">
                <div class="mh-cntr">
                    <div class="business-detail animated fadeInUpSmall">
                        <div class="business-detail-head">
                            <div class="cont-row">
                                <div class="cont-col-9">
                                    <h2 class="cont-h2">店铺基本信息</h2></div>
                                <div class="cont-col-3"><p class="t-r"><a class="btn btn-info"
                                                                          href="/Business/edit.aspx?businessId=<%=CurrentBusiness.Id %>">修改店铺信息</a>
                                </p></div>
                            </div>
                        </div>
                                    ...
                                    <div class="business-detail-stand">
                                            ...
                                            <div class="cont-col-12">
                                                <div class="t-c">
                                                    <img class="business-detail-face"
                                                         src='<%=CurrentBusiness.BusinessAvatar.Id!=Guid.Empty?"/ImageHandler.ashx?imagename="+HttpUtility.UrlEncode(CurrentBusiness.BusinessAvatar.ImageName)+"&width=125&height=125&tt=3":"../image/myshop/touxiang_125_125.png"%>'/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="cont-row">
                                        ...
                                        <div class="detail-pra">
                                            ...
                                            <div class="cont-row">
                                                ...
                                                <div class="cont-col-9"><%=string.IsNullOrEmpty( CurrentBusiness.Address )? "无" :
                                            ...
                                            <div class="cont-row">
                                                ...
                                                <div class="cont-col-9"><p class="text-breakWord"><%=CurrentBusiness.Description
                                                    %></p></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="business-detail-iden">
                                        ...
                                        <div class="detail-pra">
                                            ...
                                            <div class="cont-row">
                                                ...
                                                <div class="cont-col-7"><%=CurrentBusiness.ChargePersonIdCardType.ToString() %>
                                                </div>
                                            </div>
                                            <div class="cont-row">
                                    ...
                                    <div class="business-detail-pic">
                                        ...
                                        <div class="detail-img">
                                            <asp:Repeater runat="server" ID="rptShow">
                                                <ItemTemplate>
                                                    <a class="m-r20" data-lightbox="lb_show"
                                                       href='<%#Config.BusinessImagePath+"/original/"+Eval("ImageName") %>'> <img
                                                            src='/ImageHandler.ashx?imagename=<%#Eval("ImageName")%>&width=120&height=120&tt=3'/>
                                                    </a>
                                                </ItemTemplate>
