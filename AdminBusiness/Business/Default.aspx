                                    ...
                                    <div class="cont-container m-b20">
                                        <div class="business-list-item">
                                           <div class="cont-row">
                                               ...
                                               <div class="business-face"><img src='<%# ((Dianzhu.Model.BusinessImage)Eval("BusinessAvatar")).Id!=Guid.Empty?"/ImageHandler.ashx?imagename="+HttpUtility.UrlEncode(((Dianzhu.Model.BusinessImage)Eval("BusinessAvatar")).ImageName)+"&width=90&height=90&tt=2":"../image/myshop/touxiangkuang_11.png" %>' /></div>
