    ...
    public partial class Form1 : Form,Dianzhu.CSClient.IView.IScreenCaptureForm
    {
        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            try
            {
                ...
                shot.Captured += Shot_Captured;
                shot.CaptureImage(showCursor, curSize, curPos, StartPoint, Point.Empty, bounds);
            }
            catch (Exception ee)
            {
        ...
        private void Shot_Captured(Image image)
        {
            MemoryStream ms = new MemoryStream();
            image.Save(ms, System.Drawing.Imaging.ImageFormat.Gif);
            byte[] fileData = ms.ToArray();
           Captured(fileData, "ChatImage", "image");
