...
namespace Dianzhu.Push.XMPush
{
    ...
    public class XMRequestAndoird
    {
        ...
        int notify_id = 0;
        int notify_type = 2;
        string restricted_package_name { get { return pushType == PushType.PushToBusiness ? "ihelperseller.development.jsyk" : "ihelper.development.jsyk"; } }
        public string title { get { return pushType == PushType.PushToBusiness ? "一点办商户版" : "一点办"; } }
        public XMRequestAndoird(PushType pushtype)
        {
