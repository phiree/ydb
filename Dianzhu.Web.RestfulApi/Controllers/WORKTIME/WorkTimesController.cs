    ...
    public class WorkTimesController : ApiController
    {
        ...
        public IHttpActionResult GetWorkTimes(string storeID, string serviceID, [FromUri]common_Trait_WorkTimeFiltering worktime)
        {
            try
            {
                ...
                GetRequestHeader.GetTraitHeaders("get/stores/{storeID}/services/{serviceID}/workTimes/list");
        ...
        public IHttpActionResult DeleteWorkTime(string storeID, string serviceID, string workTimeID)
        {
            try
            {
                return Json(iworktime.DeleteWorkTime(storeID, serviceID, workTimeID, GetRequestHeader.GetTraitHeaders("delete/stores/{storeID}/services/{serviceID}/workTimes/{workTimeID}")));
            }
            catch (Exception ex)
            {
                return Content(HttpStatusCode.BadRequest, utils.SetRes_Error(ex));
