...
namespace Dianzhu.Web.RestfulApi
{
    public class SwaggerConfig
    {
        ...
        public static void RegisterWithConfig(HttpConfiguration configuration)
        {
            ...
            string strV = "$(\".footer\").html(\"<h4 style='color:#999'>[<span style='font-variant:small-caps'>基本文档：</span>\" +$(\"#input_baseUrl\")[0].value + \"，<span style='font-variant:small-caps'>版本：</span>v2]\")";
            //"docs /{ apiVersion}/ help",
            configuration
                .EnableSwagger(c =>
                {
                    ...
                    // Use "SingleApiVersion" to describe a single version API. Swagger 2.0 includes
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    c.InjectJavaScript(thisAssembly, "Dianzhu.Web.RestfulApi.Content.footer.js");
        ...
        {
            return string.Format(@"{0}\App_Data\XmlComments.xml",
