...
namespace PHSuit
{
    ...
    public class test
    {
        ...
        public void crypttest()
        {
            ...
            Console.WriteLine("localhost" + ":" + PHSuit.Security.Encrypt("data source=localhost;uid=root;pwd=root;database=dianzhu_publish", false));
            ...
            Console.WriteLine("Aliyun_Test:" + PHSuit.Security.Encrypt("data source=dev.ydban.cn;uid=jsyk2016;pwd=IQDv$qefeqFWuq_L;port=4407;database=dianzhu_publish", false));
        }
        [Test]
